...
import Screen from "../../public/images/android-picture-page-4.png";
...
const TTS_TEXT =
  "공유 화면에서 다양한 공유 옵션이 나타납니다. 노란 상자는 연락처나 앱을 통한 공유 옵션을 강조합니다. 메시지나 특정 연락처를 선택하여 사진을 공유할 수 있습니다.";

export default function AndroidPhotoPage4({ handleNext, handlers }) {

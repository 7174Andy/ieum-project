...
import Screen from "../../public/images/kakao-present-page-2.png";
...
const TTS_TEXT =
  "선물하기에서 상단에 있는 검색하기를 눌러서 원하는 항목을 검색하거나, 카테고리로 들어가서 항목별로 보실 수 있습니다. 상단에 있는 돋보기를 눌러주세요.";

export default function PresentPage2({ handleNext, handlers }) {

...
import Screen from "../../public/images/android-store-page-1.png";

import MissClickPopup from "../miss-click-popup";
import RecordingPopup from "../recording-popup";
import { glow } from "../glow";

const TTS_TEXT = "하단에 돋보기가 그려져 있는 검색을 눌러주세요.";

export default function AndroidStorePage1({ handleNext, handlers }) {

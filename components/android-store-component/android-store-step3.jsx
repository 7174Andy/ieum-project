...
import Screen from "../../public/images/android-store-page-3.png";
...
const TTS_TEXT =
  "예시로 모야모라고 썼을 때 나오는 화면입니다. 파란색 설치 버튼을 바로 눌러서 설치할 수도 있고 모야모라고 쓰여져 있는 곳을 눌러서 어플의 자세한 설명을 들을 수 있습니다.";

export default function AndroidStorePage3({ handleNext, handlers }) {

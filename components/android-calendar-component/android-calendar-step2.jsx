...
import Screen from "../../public/images/android-calendar-page-2.png";
...
const TTS_TEXT =
  '어플을 실행하면 현재 월의 달력이 표시됩니다. 하단의 "+" 버튼에 노란 상자가 있습니다. 이를 누르면 새로운 일정을 추가할 수 있습니다.';

export default function AndroidCalendarStep2({ handleNext, handlers }) {

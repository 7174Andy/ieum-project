...
import Screen from "../../public/images/android-alarm-page-1.png";

import MissClickPopup from "../miss-click-popup";
import RecordingPopup from "../recording-popup";
import { glow } from "../glow";

const TTS_TEXT = "화면에 보이는 어플을 찾아 실행해주세요.";

export default function AndroidCalendarStep1({ handleNext, handlers }) {

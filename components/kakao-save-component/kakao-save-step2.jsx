...
import Screen from "../../public/images/kakao-save-page-2.png";
...
const TTS_TEXT =
  "누르면 사진을 이렇게 확대해서 보실 수 있습니다. 저장하기는 하단에 왼쪽에 있습니다.";

export default function SavePage2({ handleNext, handlers }) {

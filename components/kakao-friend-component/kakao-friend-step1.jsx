...
const TTS_TEXT =
  "하단에서 맨 왼쪽에 있는 사람 모양을 누르면 현재 나의 친구와 내 프로필이 보입니다. 또한, 위쪽 상단에 있는 더하기와 사람 모양을 누르면 연락처로 새 친구를 저장할 수 있습니다. 저희는 연락처에 이미 저장된 친구를 더해볼 예정입니다. “새로운 친구를 만나보세요”라는 문구가 쓰여져 있는 걸 눌러주세요.";

...
import Screen from "../../public/images/apple-stopwatch-page-2.png";
...
const TTS_TEXT =
  '스톱워치 화면에서 "시작" 버튼을 클릭하면 스톱워치가 시작됩니다.';

export default function AppleStopWatchPage2({ handleNext, handlers }) {

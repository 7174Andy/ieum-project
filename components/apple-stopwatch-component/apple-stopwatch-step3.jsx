...
import Screen from "../../public/images/apple-stopwatch-page-3.png";

import MissClickPopup from "../miss-click-popup";
import RecordingPopup from "../recording-popup";
import { glow } from "../glow";

const TTS_TEXT = '"중단" 버튼은 스톱워치를 멈추고 싶을 때 눌러주세요.';

export default function AppleStopWatchPage3({ handleNext, handlers }) {

...
import Screen from "../../public/images/android-memo-page-3.png";
...
const TTS_TEXT =
  '새 노트 화면 상단에 제목 입력란이 표시됩니다. 노란 상자는 제목과 본문을 입력할 수 있는 위치를 보여줍니다. "제목" 부분을 눌러 원하는 제목을 입력하세요';

export default function AndroidMemoPage3({ handleNext, handlers }) {

...
import Screen from "../../public/images/android-memo-page-8.png";
...
const TTS_TEXT =
  "키보드 이외에 다른 곳을 누르면 키보드가 사라집니다. 이제 네모 상자를 눌러서 완료 표시해주세요. 완료 표시가 되면 글자에 줄이 생깁니다.";

export default function AndroidMemoPage8({ handleNext, handlers }) {

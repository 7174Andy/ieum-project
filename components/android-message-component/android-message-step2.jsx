...
import Screen from "../../public/images/android-message-page-2.png";
...
const TTS_TEXT =
  '메시지 어플 화면에서 우측 하단에 "+" 버튼이 노란 상자로 표시되어 있습니다. 새 메시지를 작성하려면 이 버튼을 클릭하세요.';

export default function AndroidMessagePage2({ handleNext, handlers }) {

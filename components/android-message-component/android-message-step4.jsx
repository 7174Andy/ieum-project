...
import Screen from "../../public/images/android-message-page-4.png";
...
const TTS_TEXT =
  '"받는 사람" 입력란에 이름을 입력하면 관련된 연락처가 표시됩니다. 원하는 연락처를 누르세요.';

export default function AndroidMessagePage4({ handleNext, handlers }) {

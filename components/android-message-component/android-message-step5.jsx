...
import Screen from "../../public/images/android-message-page-5.png";
...
const TTS_TEXT =
  "연락처를 선택한 후 본문 작성란에 메시지를 입력하세요. 메시지를 입력한 후 우측 하단의 화살표 아이콘이 노란 상자로 강조되어 있습니다. 이를 누르면 메시지가 전송됩니다.";

export default function AndroidMessagePage5({ handleNext, handlers }) {

...
import Screen from "../../public/images/android-message-page-3.png";
...
const TTS_TEXT =
  '새 메시지 작성 화면 상단에 "받는 사람" 입력란이 있습니다. 노란 상자는 연락처를 검색하거나 전화번호를 입력할 수 있는 영역을 강조합니다. 전화번호를 입력하거나 이름을 검색하세요.';

export default function AndroidMessagePage3({ handleNext, handlers }) {

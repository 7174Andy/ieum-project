...
import AppleAlarmPage1 from "../../../components/apple-alarm-component/apple-alarm-step1";
import AppleAlarmPage2 from "../../../components/apple-alarm-component/apple-alarm-step2";
...
export default function AppleAlarm() {
  ...
  return (
    <>
      ...
      {currPage === 2 && (
        <AppleAlarmPage1 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 3 && (
        <AppleAlarmPage2 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 4 && (
        <AppleAlarmPage3 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 5 && (
        <AppleAlarmPage4 handleNext={handleNext} handlers={handlers} />
      )}
      <CompletePopup

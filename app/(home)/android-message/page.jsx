...
import AndroidMessagePage1 from "../../../components/android-message-component/android-message-step1";
import AndroidMessagePage2 from "../../../components/android-message-component/android-message-step2";
import AndroidMessagePage3 from "../../../components/android-message-component/android-message-step3";
...
export default function AndroidAlarm() {
  ...
  return (
    <>
      ...
      {currPage === 2 && (
        <AndroidMessagePage1 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 3 && (
        <AndroidMessagePage2 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 4 && (
        <AndroidMessagePage3 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 5 && (
        <AndroidMessagePage4 handleNext={handleNext} handlers={handlers} />
      )}
      {currPage === 6 && (
        <AndroidMessagePage5 handleNext={handleNext} handlers={handlers} />
      )}
      <CompletePopup
